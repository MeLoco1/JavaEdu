...
public class Main {
    ...
    public static void main(String[] args) {
        /**
         * Immutable - считается класс, для которого верно утвеждение что для изменения состояния объекта этого класса
         * требуется создание нового экземпляра класса в нужном состоянии.
